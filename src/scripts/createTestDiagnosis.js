...
const createTestDiagnosis = async () => {
  try {
    ...
    // Find or create test user (doctor)
    ...
    const diagnosis = await Diagnosis.create({
      ...
      physicalExam: {
        ...
        neurological: 'Intact cranial nerves, normal motor and sensory function',
      ...
      treatmentPlan: {
        ...
        procedures: ['Blood pressure monitoring', 'Blood glucose monitoring'],
        followUp: 'Return in 3 months for blood pressure check and medication adjustment if needed',
        notes: 'Patient advised on lifestyle modifications including low-sodium diet and regular exercise'
      },
